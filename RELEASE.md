...
This release renames a few generators, gives time generators nanosecond resolution, and adds optional bounds to the date and time generators.
...
Stateful `invariants` are now sampled between rules instead of running all
of them.
